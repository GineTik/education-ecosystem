...
export namespace Prisma {
  ...
  */
  ...
  interface UserFieldRefs {
    ...
    readonly roleSlug: FieldRef<"User", 'String'>
  ...
  export type RoleOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"slug" | "name" | "description", ExtArgs["result"]["role"]>
  ...
  export interface RoleDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const roleWithSlugOnly = await prisma.role.findMany({ select: { slug: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Roles and only return the `slug`
     * const roleWithSlugOnly = await prisma.role.createManyAndReturn({
     *   select: { slug: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Roles and only return the `slug`
     * const roleWithSlugOnly = await prisma.role.updateManyAndReturn({
     *   select: { slug: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    roleSlug?: StringWithAggregatesFilter<"User"> | string
