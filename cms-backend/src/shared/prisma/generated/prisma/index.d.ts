...
export type ExternalLinks =
	$Result.DefaultSelection<Prisma.$ExternalLinksPayload>;
/**
 * Model Articles
 *
 */
 ...
 *
 */
export type InstitutionInstance =
	$Result.DefaultSelection<Prisma.$InstitutionInstancePayload>;
/**
 * Model InstitutionInstanceModule
 *
 */
export type InstitutionInstanceModule =
	$Result.DefaultSelection<Prisma.$InstitutionInstanceModulePayload>;
/**
 * Model InstitutionInstanceModuleType
 *
 */
export type InstitutionInstanceModuleType =
	$Result.DefaultSelection<Prisma.$InstitutionInstanceModuleTypePayload>;
...
export namespace $Enums {
	...
	export type ExternalLinkScope =
		(typeof ExternalLinkScope)[keyof typeof ExternalLinkScope];
}
...
> {
	 ...
	 * ```
	 */
	get institutionInstance(): Prisma.InstitutionInstanceDelegate<
		ExtArgs,
		ClientOptions
	>;
	 ...
	 * ```
	 */
	get institutionInstanceModule(): Prisma.InstitutionInstanceModuleDelegate<
		ExtArgs,
		ClientOptions
	>;
	 ...
	 * ```
	 */
	get institutionInstanceModuleType(): Prisma.InstitutionInstanceModuleTypeDelegate<
		ExtArgs,
		ClientOptions
	>;
}
...
export namespace Prisma {
  ...
  */
			...
			Role: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<RoleCountAggregateOutputType>
							| number;
					};
				};
			};
			...
			Email: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<EmailCountAggregateOutputType>
							| number;
					};
				};
			};
			ExternalLinks: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<ExternalLinksCountAggregateOutputType>
							| number;
					};
				};
			};
			Articles: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<ArticlesCountAggregateOutputType>
							| number;
					};
				};
			};
			InstitutionInstance: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<InstitutionInstanceCountAggregateOutputType>
							| number;
					};
				};
			};
			InstitutionInstanceModule: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<InstitutionInstanceModuleCountAggregateOutputType>
							| number;
					};
				};
			};
			InstitutionInstanceModuleType: {
				...
				operations: {
					...
					count: {
						...
						result:
							| $Utils.Optional<InstitutionInstanceModuleTypeCountAggregateOutputType>
							| number;
					};
				};
			};
	...
	export type InstitutionInstanceCountOutputTypeSelect<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		...
		externalLinks?:
			| boolean
			| InstitutionInstanceCountOutputTypeCountExternalLinksArgs;
	};
	 ...
	 */
	export type InstitutionInstanceCountOutputTypeDefaultArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 * InstitutionInstanceCountOutputType without action
	 */
	export type InstitutionInstanceCountOutputTypeCountModulesArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
	 ...
	 * InstitutionInstanceCountOutputType without action
	 */
	export type InstitutionInstanceCountOutputTypeCountUserArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		where?: UserWhereInput;
	};
	 ...
	 * InstitutionInstanceCountOutputType without action
	 */
	export type InstitutionInstanceCountOutputTypeCountExternalLinksArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
	...
	export type InstitutionInstanceModuleTypeCountOutputTypeSelect<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		InstitutionInstanceModule?:
			| boolean
			| InstitutionInstanceModuleTypeCountOutputTypeCountInstitutionInstanceModuleArgs;
	};
	 ...
	 */
	export type InstitutionInstanceModuleTypeCountOutputTypeDefaultArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 * InstitutionInstanceModuleTypeCountOutputType without action
	 */
	export type InstitutionInstanceModuleTypeCountOutputTypeCountInstitutionInstanceModuleArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		where?: InstitutionInstanceModuleWhereInput;
	};
	...
	export type UserOmit<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetOmit<
		"id" | "createdAt" | "avatarUrl" | "roleId" | "instanceId",
		ExtArgs["result"]["user"]
	>;
	...
	> extends Prisma.PrismaPromise<T> {
		...
		emails<T extends User$emailsArgs<ExtArgs> = {}>(
			args?: Subset<T, User$emailsArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			| $Result.GetResult<
		...
		role<T extends RoleDefaultArgs<ExtArgs> = {}>(
			...
			GlobalOmitOptions
		>;
		instance<T extends User$instanceArgs<ExtArgs> = {}>(
			args?: Subset<T, User$instanceArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
				"findUniqueOrThrow",
				GlobalOmitOptions
			> | null,
	...
	type GetRoleGroupByPayload<T extends RoleGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<RoleGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof RoleGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
	...
	> {
		...
		>(
			args: SubsetIntersection<T, RoleGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	> extends Prisma.PrismaPromise<T> {
		readonly [Symbol.toStringTag]: "PrismaPromise";
		User<T extends Role$UserArgs<ExtArgs> = {}>(
			args?: Subset<T, Role$UserArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			| $Result.GetResult<
					Prisma.$UserPayload<ExtArgs>,
					T,
	...
	export type GetPermissionAggregateType<T extends PermissionAggregateArgs> =
		{
			[P in keyof T & keyof AggregatePermission]: P extends
				| "_count"
				| "count"
				? T[P] extends true
					? number
		...
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<PermissionGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof PermissionGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
							: GetScalarType<
									T[P],
									PermissionGroupByOutputType[P]
								>
		...
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<EmailGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof EmailGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
	...
	> {
		...
		>(
			args: SubsetIntersection<T, EmailGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	export type ExternalLinksAggregateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		orderBy?:
			| ExternalLinksOrderByWithRelationInput
			| ExternalLinksOrderByWithRelationInput[];
		/**
		 * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
		 *
	...
	export type GetExternalLinksAggregateType<
		T extends ExternalLinksAggregateArgs,
	> = {
		[P in keyof T & keyof AggregateExternalLinks]: P extends
			| "_count"
			| "count"
			? T[P] extends true
				? number
	...
	export type ExternalLinksGroupByArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		where?: ExternalLinksWhereInput;
		orderBy?:
			| ExternalLinksOrderByWithAggregationInput
			| ExternalLinksOrderByWithAggregationInput[];
	...
	type GetExternalLinksGroupByPayload<T extends ExternalLinksGroupByArgs> =
		Prisma.PrismaPromise<
			Array<
				PickEnumerable<ExternalLinksGroupByOutputType, T["by"]> & {
					[P in keyof T &
						keyof ExternalLinksGroupByOutputType]: P extends "_count"
						? T[P] extends boolean
							? number
							: GetScalarType<
									T[P],
									ExternalLinksGroupByOutputType[P]
								>
						: GetScalarType<
								T[P],
								ExternalLinksGroupByOutputType[P]
	...
	export type ExternalLinksSelect<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
			...
			institutionInstance?:
				| boolean
				| ExternalLinks$institutionInstanceArgs<ExtArgs>;
		},
		ExtArgs["result"]["externalLinks"]
	>;

	export type ExternalLinksSelectCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type ExternalLinksSelectUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	> = $Extensions.GetOmit<
		...
		ExtArgs["result"]["externalLinks"]
	>;
	export type ExternalLinksInclude<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		institutionInstance?:
			| boolean
	...
	export type ExternalLinksIncludeCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		institutionInstance?:
			| boolean
	...
	export type ExternalLinksIncludeUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		institutionInstance?:
			| boolean
	...
	export type $ExternalLinksPayload<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		name: "ExternalLinks";
		objects: {
	...
	type ExternalLinksGetPayload<
		S extends boolean | null | undefined | ExternalLinksDefaultArgs,
	> = $Result.GetResult<Prisma.$ExternalLinksPayload, S>;

	type ExternalLinksCountArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = Omit<
		ExternalLinksFindManyArgs,
		"select" | "include" | "distinct" | "omit"
	> & {
		select?: ExternalLinksCountAggregateInputType | true;
	};

	export interface ExternalLinksDelegate<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	> {
		[K: symbol]: {
			types: Prisma.TypeMap<ExtArgs>["model"]["ExternalLinks"];
			meta: { name: "ExternalLinks" };
		};
		/**
		 ...
		 * })
		 */
		findUnique<T extends ExternalLinksFindUniqueArgs>(
			args: SelectSubset<T, ExternalLinksFindUniqueArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
				"findUnique",
				GlobalOmitOptions
			> | null,
		 ...
		 * })
		 */
		findUniqueOrThrow<T extends ExternalLinksFindUniqueOrThrowArgs>(
			args: SelectSubset<T, ExternalLinksFindUniqueOrThrowArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		 ...
		 * })
		 */
		findFirst<T extends ExternalLinksFindFirstArgs>(
			args?: SelectSubset<T, ExternalLinksFindFirstArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		 ...
		 * })
		 */
		findFirstOrThrow<T extends ExternalLinksFindFirstOrThrowArgs>(
			args?: SelectSubset<T, ExternalLinksFindFirstOrThrowArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		findMany<T extends ExternalLinksFindManyArgs>(
			args?: SelectSubset<T, ExternalLinksFindManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		create<T extends ExternalLinksCreateArgs>(
			args: SelectSubset<T, ExternalLinksCreateArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		createMany<T extends ExternalLinksCreateManyArgs>(
			args?: SelectSubset<T, ExternalLinksCreateManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 *
		 */
		createManyAndReturn<T extends ExternalLinksCreateManyAndReturnArgs>(
			args?: SelectSubset<
				T,
				ExternalLinksCreateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
		 ...
		 *
		 */
		delete<T extends ExternalLinksDeleteArgs>(
			args: SelectSubset<T, ExternalLinksDeleteArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		update<T extends ExternalLinksUpdateArgs>(
			args: SelectSubset<T, ExternalLinksUpdateArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		deleteMany<T extends ExternalLinksDeleteManyArgs>(
			args?: SelectSubset<T, ExternalLinksDeleteManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 *
		 */
		updateMany<T extends ExternalLinksUpdateManyArgs>(
			args: SelectSubset<T, ExternalLinksUpdateManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 *
		 */
		updateManyAndReturn<T extends ExternalLinksUpdateManyAndReturnArgs>(
			args: SelectSubset<
				T,
				ExternalLinksUpdateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
		 ...
		 * })
		 */
		upsert<T extends ExternalLinksUpsertArgs>(
			args: SelectSubset<T, ExternalLinksUpsertArgs<ExtArgs>>,
		): Prisma__ExternalLinksClient<
			$Result.GetResult<
				Prisma.$ExternalLinksPayload<ExtArgs>,
				T,
		...
		count<T extends ExternalLinksCountArgs>(
			...
			T extends $Utils.Record<"select", any>
				? T["select"] extends true
					...
					: GetScalarType<
							T["select"],
							ExternalLinksCountAggregateOutputType
						>
				: number
		>;
		 ...
		 * })
		 **/
		aggregate<T extends ExternalLinksAggregateArgs>(
			args: Subset<T, ExternalLinksAggregateArgs>,
		): Prisma.PrismaPromise<GetExternalLinksAggregateType<T>>;
		...
		>(
			args: SubsetIntersection<T, ExternalLinksGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
			? GetExternalLinksGroupByPayload<T>
			: Prisma.PrismaPromise<InputErrors>;
		/**
	 ...
	 * https://github.com/prisma/prisma-client-js/issues/707
	 */
	export interface Prisma__ExternalLinksClient<
		T,
		Null = never,
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	> extends Prisma.PrismaPromise<T> {
		readonly [Symbol.toStringTag]: "PrismaPromise";
		institutionInstance<
			T extends ExternalLinks$institutionInstanceArgs<ExtArgs> = {},
		>(
	 ...
	 */
	export type ExternalLinksFindUniqueArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 */
	export type ExternalLinksFindUniqueOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksFindFirstArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksFindFirstOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksFindManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksCreateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksCreateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 */
	export type ExternalLinksCreateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksUpdateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksUpdateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		data: XOR<
			ExternalLinksUpdateManyMutationInput,
			ExternalLinksUncheckedUpdateManyInput
		>;
		/**
	 ...
	 */
	export type ExternalLinksUpdateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksUpsertArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
		 ...
		 */
		create: XOR<
			ExternalLinksCreateInput,
			ExternalLinksUncheckedCreateInput
		>;
		/**
		 * In case the ExternalLinks was found with the provided `where` argument, update it with this data.
		 */
		update: XOR<
			ExternalLinksUpdateInput,
			ExternalLinksUncheckedUpdateInput
		>;
	};
	 ...
	 */
	export type ExternalLinksDeleteArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type ExternalLinksDeleteManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Filter which ExternalLinks to delete
	 ...
	 */
	export type ExternalLinks$institutionInstanceArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type ExternalLinksDefaultArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	...
	> = {
		 ...
		 */
		orderBy?:
			| ArticlesOrderByWithRelationInput
			| ArticlesOrderByWithRelationInput[];
		/**
		 * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
		 *
	...
	type ArticlesGetPayload<
		S extends boolean | null | undefined | ArticlesDefaultArgs,
	> = $Result.GetResult<Prisma.$ArticlesPayload, S>;

	type ArticlesCountArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = Omit<
		ArticlesFindManyArgs,
		"select" | "include" | "distinct" | "omit"
	> & {
	...
	> {
		...
		createManyAndReturn<T extends ArticlesCreateManyAndReturnArgs>(
			args?: SelectSubset<T, ArticlesCreateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$ArticlesPayload<ExtArgs>,
				T,
		...
		updateManyAndReturn<T extends ArticlesUpdateManyAndReturnArgs>(
			args: SelectSubset<T, ArticlesUpdateManyAndReturnArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$ArticlesPayload<ExtArgs>,
				T,
		...
		aggregate<T extends ArticlesAggregateArgs>(
			args: Subset<T, ArticlesAggregateArgs>,
		...
		>(
			args: SubsetIntersection<T, ArticlesGroupByArgs, OrderByArg> &
				InputErrors,
		): {} extends InputErrors
	...
	> = {
		...
		data: XOR<
			...
			ArticlesUncheckedUpdateManyInput
		>;
		/**
	...
	export type InstitutionInstanceAggregateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		orderBy?:
			| InstitutionInstanceOrderByWithRelationInput
			| InstitutionInstanceOrderByWithRelationInput[];
		/**
		 * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
		 *
	...
	export type GetInstitutionInstanceAggregateType<
		T extends InstitutionInstanceAggregateArgs,
	> = {
		[P in keyof T & keyof AggregateInstitutionInstance]: P extends
			| "_count"
			| "count"
			? T[P] extends true
				? number
	...
	export type InstitutionInstanceGroupByArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		where?: InstitutionInstanceWhereInput;
		orderBy?:
			| InstitutionInstanceOrderByWithAggregationInput
			| InstitutionInstanceOrderByWithAggregationInput[];
		by:
			| InstitutionInstanceScalarFieldEnum[]
			| InstitutionInstanceScalarFieldEnum;
	...
	type GetInstitutionInstanceGroupByPayload<
		T extends InstitutionInstanceGroupByArgs,
	> = Prisma.PrismaPromise<
		Array<
			PickEnumerable<InstitutionInstanceGroupByOutputType, T["by"]> & {
				[P in keyof T &
					keyof InstitutionInstanceGroupByOutputType]: P extends "_count"
					? T[P] extends boolean
						? number
						: GetScalarType<
								T[P],
								InstitutionInstanceGroupByOutputType[P]
							>
					: GetScalarType<
							T[P],
							InstitutionInstanceGroupByOutputType[P]
	...
	export type InstitutionInstanceSelect<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
			...
			externalLinks?:
				| boolean
				| InstitutionInstance$externalLinksArgs<ExtArgs>;
			_count?:
				| boolean
				| InstitutionInstanceCountOutputTypeDefaultArgs<ExtArgs>;
		},
		ExtArgs["result"]["institutionInstance"]
	>;

	export type InstitutionInstanceSelectCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type InstitutionInstanceSelectUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type InstitutionInstanceOmit<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetOmit<
		| "id"
		| "createdAt"
		...
		ExtArgs["result"]["institutionInstance"]
	>;
	export type InstitutionInstanceInclude<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		modules?: boolean | InstitutionInstance$modulesArgs<ExtArgs>;
		User?: boolean | InstitutionInstance$UserArgs<ExtArgs>;
	...
	export type InstitutionInstanceIncludeCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {};
	export type InstitutionInstanceIncludeUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {};

	export type $InstitutionInstancePayload<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
	...
	type InstitutionInstanceGetPayload<
		S extends boolean | null | undefined | InstitutionInstanceDefaultArgs,
	> = $Result.GetResult<Prisma.$InstitutionInstancePayload, S>;

	type InstitutionInstanceCountArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = Omit<
		InstitutionInstanceFindManyArgs,
		"select" | "include" | "distinct" | "omit"
	> & {
		select?: InstitutionInstanceCountAggregateInputType | true;
	};

	export interface InstitutionInstanceDelegate<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	> {
		[K: symbol]: {
			types: Prisma.TypeMap<ExtArgs>["model"]["InstitutionInstance"];
			meta: { name: "InstitutionInstance" };
		};
		/**
		 ...
		 * })
		 */
		findUnique<T extends InstitutionInstanceFindUniqueArgs>(
			args: SelectSubset<T, InstitutionInstanceFindUniqueArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
		 ...
		 * })
		 */
		findUniqueOrThrow<T extends InstitutionInstanceFindUniqueOrThrowArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceFindUniqueOrThrowArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
		 ...
		 * })
		 */
		findFirst<T extends InstitutionInstanceFindFirstArgs>(
			args?: SelectSubset<T, InstitutionInstanceFindFirstArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
		 ...
		 * })
		 */
		findFirstOrThrow<T extends InstitutionInstanceFindFirstOrThrowArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceFindFirstOrThrowArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
		 ...
		 *
		 */
		findMany<T extends InstitutionInstanceFindManyArgs>(
			args?: SelectSubset<T, InstitutionInstanceFindManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		create<T extends InstitutionInstanceCreateArgs>(
			args: SelectSubset<T, InstitutionInstanceCreateArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		createMany<T extends InstitutionInstanceCreateManyArgs>(
			args?: SelectSubset<T, InstitutionInstanceCreateManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 */
		createManyAndReturn<
			T extends InstitutionInstanceCreateManyAndReturnArgs,
		>(
			args?: SelectSubset<
				T,
				InstitutionInstanceCreateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
		 ...
		 *
		 */
		delete<T extends InstitutionInstanceDeleteArgs>(
			args: SelectSubset<T, InstitutionInstanceDeleteArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		update<T extends InstitutionInstanceUpdateArgs>(
			args: SelectSubset<T, InstitutionInstanceUpdateArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		deleteMany<T extends InstitutionInstanceDeleteManyArgs>(
			args?: SelectSubset<T, InstitutionInstanceDeleteManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 *
		 */
		updateMany<T extends InstitutionInstanceUpdateManyArgs>(
			args: SelectSubset<T, InstitutionInstanceUpdateManyArgs<ExtArgs>>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 */
		updateManyAndReturn<
			T extends InstitutionInstanceUpdateManyAndReturnArgs,
		>(
			args: SelectSubset<
				T,
				InstitutionInstanceUpdateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
		 ...
		 * })
		 */
		upsert<T extends InstitutionInstanceUpsertArgs>(
			args: SelectSubset<T, InstitutionInstanceUpsertArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			$Result.GetResult<
				Prisma.$InstitutionInstancePayload<ExtArgs>,
				T,
		...
		count<T extends InstitutionInstanceCountArgs>(
			...
			T extends $Utils.Record<"select", any>
				? T["select"] extends true
					...
					: GetScalarType<
							T["select"],
							InstitutionInstanceCountAggregateOutputType
						>
				: number
		>;
		 ...
		 * })
		 **/
		aggregate<T extends InstitutionInstanceAggregateArgs>(
			args: Subset<T, InstitutionInstanceAggregateArgs>,
		): Prisma.PrismaPromise<GetInstitutionInstanceAggregateType<T>>;
		...
		>(
			args: SubsetIntersection<
				T,
				InstitutionInstanceGroupByArgs,
				OrderByArg
			> &
				InputErrors,
		): {} extends InputErrors
			? GetInstitutionInstanceGroupByPayload<T>
			: Prisma.PrismaPromise<InputErrors>;
		/**
	 ...
	 * https://github.com/prisma/prisma-client-js/issues/707
	 */
	export interface Prisma__InstitutionInstanceClient<
		T,
		Null = never,
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	> extends Prisma.PrismaPromise<T> {
		readonly [Symbol.toStringTag]: "PrismaPromise";
		modules<T extends InstitutionInstance$modulesArgs<ExtArgs> = {}>(
			args?: Subset<T, InstitutionInstance$modulesArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			| $Result.GetResult<
					Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
					T,
					"findMany",
					GlobalOmitOptions
			  >
			| Null
		>;
		User<T extends InstitutionInstance$UserArgs<ExtArgs> = {}>(
			args?: Subset<T, InstitutionInstance$UserArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			| $Result.GetResult<
					Prisma.$UserPayload<ExtArgs>,
					T,
		...
		>;
		externalLinks<
			T extends InstitutionInstance$externalLinksArgs<ExtArgs> = {},
		>(
			args?: Subset<T, InstitutionInstance$externalLinksArgs<ExtArgs>>,
		): Prisma.PrismaPromise<
			| $Result.GetResult<
					Prisma.$ExternalLinksPayload<ExtArgs>,
					T,
	 ...
	 */
	export type InstitutionInstanceFindUniqueArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceFindUniqueOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceFindFirstArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceFindFirstOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceFindManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceCreateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
		 ...
		 */
		data: XOR<
			InstitutionInstanceCreateInput,
			InstitutionInstanceUncheckedCreateInput
		>;
	};
	 ...
	 */
	export type InstitutionInstanceCreateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		data:
			| InstitutionInstanceCreateManyInput
			| InstitutionInstanceCreateManyInput[];
		skipDuplicates?: boolean;
	};
	 ...
	 */
	export type InstitutionInstanceCreateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceUpdateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
		 ...
		 */
		data: XOR<
			InstitutionInstanceUpdateInput,
			InstitutionInstanceUncheckedUpdateInput
		>;
		/**
	 ...
	 */
	export type InstitutionInstanceUpdateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		data: XOR<
			InstitutionInstanceUpdateManyMutationInput,
			InstitutionInstanceUncheckedUpdateManyInput
		>;
		/**
	 ...
	 */
	export type InstitutionInstanceUpdateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceUpsertArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceDeleteArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	 ...
	 */
	export type InstitutionInstanceDeleteManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 */
	export type InstitutionInstance$modulesArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		...
		where?: InstitutionInstanceModuleWhereInput;
		orderBy?:
			| InstitutionInstanceModuleOrderByWithRelationInput
			| InstitutionInstanceModuleOrderByWithRelationInput[];
		cursor?: InstitutionInstanceModuleWhereUniqueInput;
		take?: number;
		skip?: number;
		distinct?:
			| InstitutionInstanceModuleScalarFieldEnum
			| InstitutionInstanceModuleScalarFieldEnum[];
	};
	 ...
	 */
	export type InstitutionInstance$UserArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the User
	 ...
	 */
	export type InstitutionInstance$externalLinksArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the ExternalLinks
	 ...
	 */
	export type InstitutionInstanceDefaultArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstance
	...
	export type InstitutionInstanceModuleAggregateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	...
	export type GetInstitutionInstanceModuleAggregateType<
		T extends InstitutionInstanceModuleAggregateArgs,
	> = {
		[P in keyof T & keyof AggregateInstitutionInstanceModule]: P extends
			| "_count"
			| "count"
			? T[P] extends true
				? number
	...
	export type InstitutionInstanceModuleGroupByArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		where?: InstitutionInstanceModuleWhereInput;
		orderBy?:
			| InstitutionInstanceModuleOrderByWithAggregationInput
			| InstitutionInstanceModuleOrderByWithAggregationInput[];
		by:
			| InstitutionInstanceModuleScalarFieldEnum[]
			| InstitutionInstanceModuleScalarFieldEnum;
	...
	type GetInstitutionInstanceModuleGroupByPayload<
		T extends InstitutionInstanceModuleGroupByArgs,
	> = Prisma.PrismaPromise<
		Array<
			PickEnumerable<
				InstitutionInstanceModuleGroupByOutputType,
				T["by"]
			> & {
				[P in keyof T &
					keyof InstitutionInstanceModuleGroupByOutputType]: P extends "_count"
					? T[P] extends boolean
						? number
						: GetScalarType<
								T[P],
								InstitutionInstanceModuleGroupByOutputType[P]
							>
					: GetScalarType<
							T[P],
							InstitutionInstanceModuleGroupByOutputType[P]
	...
	export type InstitutionInstanceModuleSelect<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type InstitutionInstanceModuleSelectCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type InstitutionInstanceModuleSelectUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type InstitutionInstanceModuleOmit<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetOmit<
		| "id"
		| "createdAt"
		...
		ExtArgs["result"]["institutionInstanceModule"]
	>;
	export type InstitutionInstanceModuleInclude<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		instance?: boolean | InstitutionInstanceDefaultArgs<ExtArgs>;
		type?: boolean | InstitutionInstanceModuleTypeDefaultArgs<ExtArgs>;
	};
	export type InstitutionInstanceModuleIncludeCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		instance?: boolean | InstitutionInstanceDefaultArgs<ExtArgs>;
		type?: boolean | InstitutionInstanceModuleTypeDefaultArgs<ExtArgs>;
	};
	export type InstitutionInstanceModuleIncludeUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		instance?: boolean | InstitutionInstanceDefaultArgs<ExtArgs>;
		type?: boolean | InstitutionInstanceModuleTypeDefaultArgs<ExtArgs>;
	...
	export type $InstitutionInstanceModulePayload<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
	...
	type InstitutionInstanceModuleGetPayload<
		S extends
			| boolean
			| null
			| undefined
			| InstitutionInstanceModuleDefaultArgs,
	> = $Result.GetResult<Prisma.$InstitutionInstanceModulePayload, S>;

	type InstitutionInstanceModuleCountArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = Omit<
		InstitutionInstanceModuleFindManyArgs,
		"select" | "include" | "distinct" | "omit"
	> & {
		select?: InstitutionInstanceModuleCountAggregateInputType | true;
	};

	export interface InstitutionInstanceModuleDelegate<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	> {
		[K: symbol]: {
			types: Prisma.TypeMap<ExtArgs>["model"]["InstitutionInstanceModule"];
			meta: { name: "InstitutionInstanceModule" };
		};
		/**
		 ...
		 * })
		 */
		findUnique<T extends InstitutionInstanceModuleFindUniqueArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleFindUniqueArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
				T,
				"findUnique",
		 ...
		 */
		findUniqueOrThrow<
			T extends InstitutionInstanceModuleFindUniqueOrThrowArgs,
		>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleFindUniqueOrThrowArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
		 ...
		 * })
		 */
		findFirst<T extends InstitutionInstanceModuleFindFirstArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleFindFirstArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
		 ...
		 */
		findFirstOrThrow<
			T extends InstitutionInstanceModuleFindFirstOrThrowArgs,
		>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleFindFirstOrThrowArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
		 ...
		 *
		 */
		findMany<T extends InstitutionInstanceModuleFindManyArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleFindManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
		 ...
		 *
		 */
		create<T extends InstitutionInstanceModuleCreateArgs>(
			args: SelectSubset<T, InstitutionInstanceModuleCreateArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		createMany<T extends InstitutionInstanceModuleCreateManyArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleCreateManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 */
		createManyAndReturn<
			T extends InstitutionInstanceModuleCreateManyAndReturnArgs,
		>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleCreateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
		 ...
		 *
		 */
		delete<T extends InstitutionInstanceModuleDeleteArgs>(
			args: SelectSubset<T, InstitutionInstanceModuleDeleteArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		update<T extends InstitutionInstanceModuleUpdateArgs>(
			args: SelectSubset<T, InstitutionInstanceModuleUpdateArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
				T,
		 ...
		 *
		 */
		deleteMany<T extends InstitutionInstanceModuleDeleteManyArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleDeleteManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 *
		 */
		updateMany<T extends InstitutionInstanceModuleUpdateManyArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleUpdateManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 */
		updateManyAndReturn<
			T extends InstitutionInstanceModuleUpdateManyAndReturnArgs,
		>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleUpdateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
		 ...
		 * })
		 */
		upsert<T extends InstitutionInstanceModuleUpsertArgs>(
			args: SelectSubset<T, InstitutionInstanceModuleUpsertArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceModuleClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModulePayload<ExtArgs>,
				T,
		...
		count<T extends InstitutionInstanceModuleCountArgs>(
			...
			T extends $Utils.Record<"select", any>
				? T["select"] extends true
					...
					: GetScalarType<
							T["select"],
							InstitutionInstanceModuleCountAggregateOutputType
						>
				: number
		>;
		 ...
		 * })
		 **/
		aggregate<T extends InstitutionInstanceModuleAggregateArgs>(
			args: Subset<T, InstitutionInstanceModuleAggregateArgs>,
		): Prisma.PrismaPromise<GetInstitutionInstanceModuleAggregateType<T>>;
		...
		>(
			args: SubsetIntersection<
				T,
				InstitutionInstanceModuleGroupByArgs,
				OrderByArg
			> &
				InputErrors,
		): {} extends InputErrors
			? GetInstitutionInstanceModuleGroupByPayload<T>
			: Prisma.PrismaPromise<InputErrors>;
		/**
	 ...
	 * https://github.com/prisma/prisma-client-js/issues/707
	 */
	export interface Prisma__InstitutionInstanceModuleClient<
		T,
		Null = never,
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	> extends Prisma.PrismaPromise<T> {
		readonly [Symbol.toStringTag]: "PrismaPromise";
		instance<T extends InstitutionInstanceDefaultArgs<ExtArgs> = {}>(
			args?: Subset<T, InstitutionInstanceDefaultArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceClient<
			| $Result.GetResult<
					Prisma.$InstitutionInstancePayload<ExtArgs>,
					T,
			...
			GlobalOmitOptions
		>;
		type<T extends InstitutionInstanceModuleTypeDefaultArgs<ExtArgs> = {}>(
			args?: Subset<T, InstitutionInstanceModuleTypeDefaultArgs<ExtArgs>>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			| $Result.GetResult<
					Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
					T,
					"findUniqueOrThrow",
					GlobalOmitOptions
			  >
	...
	interface InstitutionInstanceModuleFieldRefs {
		...
		readonly expectedMajorVersion: FieldRef<
			"InstitutionInstanceModule",
			"Int"
		>;
		readonly expectedMinorVersion: FieldRef<
			"InstitutionInstanceModule",
			"Int"
		>;
	 ...
	 */
	export type InstitutionInstanceModuleFindUniqueArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleFindUniqueOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleFindFirstArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleFindFirstOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleFindManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleCreateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
		 ...
		 */
		data: XOR<
			InstitutionInstanceModuleCreateInput,
			InstitutionInstanceModuleUncheckedCreateInput
		>;
	};
	 ...
	 */
	export type InstitutionInstanceModuleCreateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		data:
			| InstitutionInstanceModuleCreateManyInput
			| InstitutionInstanceModuleCreateManyInput[];
		skipDuplicates?: boolean;
	};
	 ...
	 */
	export type InstitutionInstanceModuleCreateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleUpdateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
		 ...
		 */
		data: XOR<
			InstitutionInstanceModuleUpdateInput,
			InstitutionInstanceModuleUncheckedUpdateInput
		>;
		/**
	 ...
	 */
	export type InstitutionInstanceModuleUpdateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		data: XOR<
			InstitutionInstanceModuleUpdateManyMutationInput,
			InstitutionInstanceModuleUncheckedUpdateManyInput
		>;
		/**
	 ...
	 */
	export type InstitutionInstanceModuleUpdateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleUpsertArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleDeleteArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleDeleteManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 */
	export type InstitutionInstanceModuleDefaultArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	...
	export type InstitutionInstanceModuleTypeAggregateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		orderBy?:
			| InstitutionInstanceModuleTypeOrderByWithRelationInput
			| InstitutionInstanceModuleTypeOrderByWithRelationInput[];
		/**
		 * {@link https://www.prisma.io/docs/concepts/components/prisma-client/pagination#cursor-based-pagination Cursor Docs}
		 *
	...
	export type GetInstitutionInstanceModuleTypeAggregateType<
		T extends InstitutionInstanceModuleTypeAggregateArgs,
	> = {
		[P in keyof T &
			keyof AggregateInstitutionInstanceModuleType]: P extends
			| "_count"
			| "count"
			? T[P] extends true
				? number
	...
	export type InstitutionInstanceModuleTypeGroupByArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		where?: InstitutionInstanceModuleTypeWhereInput;
		orderBy?:
			| InstitutionInstanceModuleTypeOrderByWithAggregationInput
			| InstitutionInstanceModuleTypeOrderByWithAggregationInput[];
		by:
			| InstitutionInstanceModuleTypeScalarFieldEnum[]
			| InstitutionInstanceModuleTypeScalarFieldEnum;
	...
	type GetInstitutionInstanceModuleTypeGroupByPayload<
		T extends InstitutionInstanceModuleTypeGroupByArgs,
	> = Prisma.PrismaPromise<
		Array<
			PickEnumerable<
				InstitutionInstanceModuleTypeGroupByOutputType,
				T["by"]
			> & {
				[P in keyof T &
					keyof InstitutionInstanceModuleTypeGroupByOutputType]: P extends "_count"
					? T[P] extends boolean
						? number
						: GetScalarType<
								T[P],
								InstitutionInstanceModuleTypeGroupByOutputType[P]
							>
					: GetScalarType<
							T[P],
							InstitutionInstanceModuleTypeGroupByOutputType[P]
	...
	export type InstitutionInstanceModuleTypeSelect<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
			...
			InstitutionInstanceModule?:
				| boolean
				| InstitutionInstanceModuleType$InstitutionInstanceModuleArgs<ExtArgs>;
			_count?:
				| boolean
				| InstitutionInstanceModuleTypeCountOutputTypeDefaultArgs<ExtArgs>;
		},
		ExtArgs["result"]["institutionInstanceModuleType"]
	>;

	export type InstitutionInstanceModuleTypeSelectCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type InstitutionInstanceModuleTypeSelectUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetSelect<
		{
			id?: boolean;
	...
	export type InstitutionInstanceModuleTypeOmit<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = $Extensions.GetOmit<
		"id" | "slug" | "name",
		ExtArgs["result"]["institutionInstanceModuleType"]
	>;
	export type InstitutionInstanceModuleTypeInclude<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		InstitutionInstanceModule?:
			| boolean
	...
	export type InstitutionInstanceModuleTypeIncludeCreateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {};
	export type InstitutionInstanceModuleTypeIncludeUpdateManyAndReturn<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {};

	export type $InstitutionInstanceModuleTypePayload<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
	...
	type InstitutionInstanceModuleTypeGetPayload<
		S extends
			| boolean
			| null
			| undefined
			| InstitutionInstanceModuleTypeDefaultArgs,
	> = $Result.GetResult<Prisma.$InstitutionInstanceModuleTypePayload, S>;

	type InstitutionInstanceModuleTypeCountArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = Omit<
		InstitutionInstanceModuleTypeFindManyArgs,
		"select" | "include" | "distinct" | "omit"
	> & {
		select?: InstitutionInstanceModuleTypeCountAggregateInputType | true;
	};

	export interface InstitutionInstanceModuleTypeDelegate<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	> {
		[K: symbol]: {
			types: Prisma.TypeMap<ExtArgs>["model"]["InstitutionInstanceModuleType"];
			meta: { name: "InstitutionInstanceModuleType" };
		};
		/**
		 ...
		 * })
		 */
		findUnique<T extends InstitutionInstanceModuleTypeFindUniqueArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeFindUniqueArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 */
		findUniqueOrThrow<
			T extends InstitutionInstanceModuleTypeFindUniqueOrThrowArgs,
		>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeFindUniqueOrThrowArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 * })
		 */
		findFirst<T extends InstitutionInstanceModuleTypeFindFirstArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleTypeFindFirstArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 */
		findFirstOrThrow<
			T extends InstitutionInstanceModuleTypeFindFirstOrThrowArgs,
		>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleTypeFindFirstOrThrowArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 *
		 */
		findMany<T extends InstitutionInstanceModuleTypeFindManyArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleTypeFindManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 *
		 */
		create<T extends InstitutionInstanceModuleTypeCreateArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeCreateArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 *
		 */
		createMany<T extends InstitutionInstanceModuleTypeCreateManyArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleTypeCreateManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 */
		createManyAndReturn<
			T extends InstitutionInstanceModuleTypeCreateManyAndReturnArgs,
		>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleTypeCreateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 *
		 */
		delete<T extends InstitutionInstanceModuleTypeDeleteArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeDeleteArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 *
		 */
		update<T extends InstitutionInstanceModuleTypeUpdateArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeUpdateArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 *
		 */
		deleteMany<T extends InstitutionInstanceModuleTypeDeleteManyArgs>(
			args?: SelectSubset<
				T,
				InstitutionInstanceModuleTypeDeleteManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 *
		 */
		updateMany<T extends InstitutionInstanceModuleTypeUpdateManyArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeUpdateManyArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<BatchPayload>;
		 ...
		 */
		updateManyAndReturn<
			T extends InstitutionInstanceModuleTypeUpdateManyAndReturnArgs,
		>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeUpdateManyAndReturnArgs<ExtArgs>
			>,
		): Prisma.PrismaPromise<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		 ...
		 * })
		 */
		upsert<T extends InstitutionInstanceModuleTypeUpsertArgs>(
			args: SelectSubset<
				T,
				InstitutionInstanceModuleTypeUpsertArgs<ExtArgs>
			>,
		): Prisma__InstitutionInstanceModuleTypeClient<
			$Result.GetResult<
				Prisma.$InstitutionInstanceModuleTypePayload<ExtArgs>,
		...
		count<T extends InstitutionInstanceModuleTypeCountArgs>(
			...
			T extends $Utils.Record<"select", any>
				? T["select"] extends true
					...
					: GetScalarType<
							T["select"],
							InstitutionInstanceModuleTypeCountAggregateOutputType
						>
				: number
		>;
		 ...
		 * })
		 **/
		aggregate<T extends InstitutionInstanceModuleTypeAggregateArgs>(
			args: Subset<T, InstitutionInstanceModuleTypeAggregateArgs>,
		): Prisma.PrismaPromise<
			GetInstitutionInstanceModuleTypeAggregateType<T>
		>;
		...
		>(
			args: SubsetIntersection<
				T,
				InstitutionInstanceModuleTypeGroupByArgs,
				OrderByArg
			> &
				InputErrors,
		): {} extends InputErrors
			? GetInstitutionInstanceModuleTypeGroupByPayload<T>
			: Prisma.PrismaPromise<InputErrors>;
		/**
	 ...
	 * https://github.com/prisma/prisma-client-js/issues/707
	 */
	export interface Prisma__InstitutionInstanceModuleTypeClient<
		T,
		Null = never,
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
		GlobalOmitOptions = {},
	 ...
	 */
	export type InstitutionInstanceModuleTypeFindUniqueArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 */
	export type InstitutionInstanceModuleTypeFindUniqueOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeFindFirstArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeFindFirstOrThrowArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeFindManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeCreateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
		 ...
		 */
		data: XOR<
			InstitutionInstanceModuleTypeCreateInput,
			InstitutionInstanceModuleTypeUncheckedCreateInput
		>;
	};
	 ...
	 */
	export type InstitutionInstanceModuleTypeCreateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		data:
			| InstitutionInstanceModuleTypeCreateManyInput
			| InstitutionInstanceModuleTypeCreateManyInput[];
		skipDuplicates?: boolean;
	};
	 ...
	 */
	export type InstitutionInstanceModuleTypeCreateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeUpdateArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
		 ...
		 */
		data: XOR<
			InstitutionInstanceModuleTypeUpdateInput,
			InstitutionInstanceModuleTypeUncheckedUpdateInput
		>;
		/**
	 ...
	 */
	export type InstitutionInstanceModuleTypeUpdateManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 ...
		 */
		data: XOR<
			InstitutionInstanceModuleTypeUpdateManyMutationInput,
			InstitutionInstanceModuleTypeUncheckedUpdateManyInput
		>;
		/**
	 ...
	 */
	export type InstitutionInstanceModuleTypeUpdateManyAndReturnArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeUpsertArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeDeleteArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	 ...
	 */
	export type InstitutionInstanceModuleTypeDeleteManyArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
	 ...
	 */
	export type InstitutionInstanceModuleType$InstitutionInstanceModuleArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModule
	 ...
	 */
	export type InstitutionInstanceModuleTypeDefaultArgs<
		ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
	> = {
		/**
		 * Select specific fields to fetch from the InstitutionInstanceModuleType
	...
	export type ExternalLinksScalarFieldEnum =
		(typeof ExternalLinksScalarFieldEnum)[keyof typeof ExternalLinksScalarFieldEnum];
	...
	export type InstitutionInstanceScalarFieldEnum =
		(typeof InstitutionInstanceScalarFieldEnum)[keyof typeof InstitutionInstanceScalarFieldEnum];
	...
	export type InstitutionInstanceModuleScalarFieldEnum =
		(typeof InstitutionInstanceModuleScalarFieldEnum)[keyof typeof InstitutionInstanceModuleScalarFieldEnum];
	...
	export type InstitutionInstanceModuleTypeScalarFieldEnum =
		(typeof InstitutionInstanceModuleTypeScalarFieldEnum)[keyof typeof InstitutionInstanceModuleTypeScalarFieldEnum];
	 ...
	 */
	export type EnumExternalLinkScopeFieldRefInput<$PrismaModel> =
		FieldRefInputType<$PrismaModel, "ExternalLinkScope">;

	/**
	 * Reference to a field of type 'ExternalLinkScope[]'
	 */
	export type ListEnumExternalLinkScopeFieldRefInput<$PrismaModel> =
		FieldRefInputType<$PrismaModel, "ExternalLinkScope[]">;
	...
	export type UserWhereInput = {
		...
		instance?: XOR<
			InstitutionInstanceNullableScalarRelationFilter,
			InstitutionInstanceWhereInput
		> | null;
	};
	...
	export type ExternalLinksWhereInput = {
		...
		scope?:
			| EnumExternalLinkScopeFilter<"ExternalLinks">
			| $Enums.ExternalLinkScope;
		institutionInstanceId?:
			| StringNullableFilter<"ExternalLinks">
			| string
			| null;
		institutionInstance?: XOR<
			InstitutionInstanceNullableScalarRelationFilter,
			InstitutionInstanceWhereInput
		> | null;
	};
	...
	export type ExternalLinksScalarWhereWithAggregatesInput = {
		AND?:
			| ExternalLinksScalarWhereWithAggregatesInput
			| ExternalLinksScalarWhereWithAggregatesInput[];
		...
		createdAt?:
			| DateTimeWithAggregatesFilter<"ExternalLinks">
			| Date
			| string;
		updatedAt?:
			| DateTimeWithAggregatesFilter<"ExternalLinks">
		...
		scope?:
			| EnumExternalLinkScopeWithAggregatesFilter<"ExternalLinks">
			| $Enums.ExternalLinkScope;
		institutionInstanceId?:
			| StringNullableWithAggregatesFilter<"ExternalLinks">
			| string
			| null;
	};
	...
	export type ArticlesWhereUniqueInput = Prisma.AtLeast<
		{
			...
			isPublished?: BoolFilter<"Articles"> | boolean;
			publishedAt?:
				| DateTimeNullableFilter<"Articles">
				| Date
				| string
				| null;
			createdAt?: DateTimeFilter<"Articles"> | Date | string;
	...
	export type ArticlesScalarWhereWithAggregatesInput = {
		...
		publishedAt?:
			| DateTimeNullableWithAggregatesFilter<"Articles">
			| Date
			| string
			| null;
	...
	export type InstitutionInstanceScalarWhereWithAggregatesInput = {
		AND?:
			| InstitutionInstanceScalarWhereWithAggregatesInput
			| InstitutionInstanceScalarWhereWithAggregatesInput[];
		...
		createdAt?:
			| DateTimeWithAggregatesFilter<"InstitutionInstance">
			| Date
			| string;
		updatedAt?:
			| DateTimeWithAggregatesFilter<"InstitutionInstance">
			...
			| string;
		institutionName?:
			| StringWithAggregatesFilter<"InstitutionInstance">
			| string;
		institutionSlug?:
			| StringWithAggregatesFilter<"InstitutionInstance">
			| string;
	...
	export type InstitutionInstanceModuleWhereInput = {
		AND?:
			| InstitutionInstanceModuleWhereInput
			| InstitutionInstanceModuleWhereInput[];
		...
		apiKey?:
			| StringNullableFilter<"InstitutionInstanceModule">
			| string
			| null;
		...
		instance?: XOR<
			InstitutionInstanceScalarRelationFilter,
			InstitutionInstanceWhereInput
		>;
		type?: XOR<
			InstitutionInstanceModuleTypeScalarRelationFilter,
			InstitutionInstanceModuleTypeWhereInput
		>;
	};
	...
	export type InstitutionInstanceModuleWhereUniqueInput = Prisma.AtLeast<
		{
			...
			NOT?:
				...
				| InstitutionInstanceModuleWhereInput[];
			createdAt?:
				| DateTimeFilter<"InstitutionInstanceModule">
				| Date
				| string;
			updatedAt?:
				| DateTimeFilter<"InstitutionInstanceModule">
			...
			apiKey?:
				...
				| null;
			expectedMajorVersion?:
				| IntFilter<"InstitutionInstanceModule">
				| number;
			expectedMinorVersion?:
				| IntFilter<"InstitutionInstanceModule">
				| number;
	...
	export type InstitutionInstanceModuleScalarWhereWithAggregatesInput = {
		AND?:
			| InstitutionInstanceModuleScalarWhereWithAggregatesInput
			| InstitutionInstanceModuleScalarWhereWithAggregatesInput[];
		...
		createdAt?:
			| DateTimeWithAggregatesFilter<"InstitutionInstanceModule">
			| Date
			| string;
		updatedAt?:
			| DateTimeWithAggregatesFilter<"InstitutionInstanceModule">
			...
			| string;
		baseURL?:
			| StringWithAggregatesFilter<"InstitutionInstanceModule">
			| string;
		isEnabled?:
			| BoolWithAggregatesFilter<"InstitutionInstanceModule">
			| boolean;
		status?:
			| StringWithAggregatesFilter<"InstitutionInstanceModule">
			| string;
		apiKey?:
			| StringNullableWithAggregatesFilter<"InstitutionInstanceModule">
			| string
			| null;
		expectedMajorVersion?:
			| IntWithAggregatesFilter<"InstitutionInstanceModule">
			| number;
		expectedMinorVersion?:
			| IntWithAggregatesFilter<"InstitutionInstanceModule">
			| number;
	...
	export type InstitutionInstanceModuleTypeScalarWhereWithAggregatesInput = {
		AND?:
			| InstitutionInstanceModuleTypeScalarWhereWithAggregatesInput
			| InstitutionInstanceModuleTypeScalarWhereWithAggregatesInput[];
		...
		NOT?:
			...
			| InstitutionInstanceModuleTypeScalarWhereWithAggregatesInput[];
		id?:
			| StringWithAggregatesFilter<"InstitutionInstanceModuleType">
			| string;
		slug?:
			| StringWithAggregatesFilter<"InstitutionInstanceModuleType">
			| string;
	...
	export type ExternalLinksUpdateInput = {
		...
		scope?:
			| EnumExternalLinkScopeFieldUpdateOperationsInput
			| $Enums.ExternalLinkScope;
	...
	export type InstitutionInstanceCreateInput = {
		...
		institutionSlug: string;
		validMailDomains?:
			| InstitutionInstanceCreatevalidMailDomainsInput
			| string[];
	...
	export type InstitutionInstanceUpdateInput = {
		...
		validMailDomains?:
			| InstitutionInstanceUpdatevalidMailDomainsInput
			| string[];
	...
	export type EnumExternalLinkScopeFilter<$PrismaModel = never> = {
		equals?:
			| $Enums.ExternalLinkScope
			| EnumExternalLinkScopeFieldRefInput<$PrismaModel>;
		in?:
			| $Enums.ExternalLinkScope[]
			| ListEnumExternalLinkScopeFieldRefInput<$PrismaModel>;
		notIn?:
			| $Enums.ExternalLinkScope[]
			| ListEnumExternalLinkScopeFieldRefInput<$PrismaModel>;
		not?:
			| NestedEnumExternalLinkScopeFilter<$PrismaModel>
			| $Enums.ExternalLinkScope;
	};
	...
	export type EnumExternalLinkScopeWithAggregatesFilter<
		$PrismaModel = never,
	> = {
		equals?:
			| $Enums.ExternalLinkScope
		...
		notIn?:
			...
			| ListEnumExternalLinkScopeFieldRefInput<$PrismaModel>;
		not?:
			| NestedEnumExternalLinkScopeWithAggregatesFilter<$PrismaModel>
			| $Enums.ExternalLinkScope;
		_count?: NestedIntFilter<$PrismaModel>;
	...
	export type InstitutionInstanceCreateNestedOneWithoutUserInput = {
		create?: XOR<
			InstitutionInstanceCreateWithoutUserInput,
			InstitutionInstanceUncheckedCreateWithoutUserInput
		>;
	...
	export type InstitutionInstanceUpdateOneWithoutUserNestedInput = {
		...
		update?: XOR<
			XOR<
				InstitutionInstanceUpdateToOneWithWhereWithoutUserInput,
				InstitutionInstanceUpdateWithoutUserInput
			>,
			InstitutionInstanceUncheckedUpdateWithoutUserInput
		>;
	};
	...
	export type UserCreateNestedOneWithoutEmailsInput = {
		create?: XOR<
			UserCreateWithoutEmailsInput,
			UserUncheckedCreateWithoutEmailsInput
		>;
	...
	export type UserUpdateOneRequiredWithoutEmailsNestedInput = {
		...
		update?: XOR<
			XOR<
				UserUpdateToOneWithWhereWithoutEmailsInput,
				UserUpdateWithoutEmailsInput
			>,
			UserUncheckedUpdateWithoutEmailsInput
		>;
	};

	export type InstitutionInstanceCreateNestedOneWithoutExternalLinksInput = {
		create?: XOR<
			InstitutionInstanceCreateWithoutExternalLinksInput,
			InstitutionInstanceUncheckedCreateWithoutExternalLinksInput
		>;
	...
	export type InstitutionInstanceUpdateOneWithoutExternalLinksNestedInput = {
		...
		update?: XOR<
			XOR<
				InstitutionInstanceUpdateToOneWithWhereWithoutExternalLinksInput,
				InstitutionInstanceUpdateWithoutExternalLinksInput
			>,
			InstitutionInstanceUncheckedUpdateWithoutExternalLinksInput
		>;
	};
	...
	export type InstitutionInstanceModuleCreateNestedManyWithoutInstanceInput =
		{
			create?:
				| XOR<
						InstitutionInstanceModuleCreateWithoutInstanceInput,
						InstitutionInstanceModuleUncheckedCreateWithoutInstanceInput
				  >
				| InstitutionInstanceModuleCreateWithoutInstanceInput[]
				| InstitutionInstanceModuleUncheckedCreateWithoutInstanceInput[];
			connectOrCreate?:
				| InstitutionInstanceModuleCreateOrConnectWithoutInstanceInput
				| InstitutionInstanceModuleCreateOrConnectWithoutInstanceInput[];
			createMany?: InstitutionInstanceModuleCreateManyInstanceInputEnvelope;
			connect?:
				| InstitutionInstanceModuleWhereUniqueInput
				| InstitutionInstanceModuleWhereUniqueInput[];
		};
	...
	export type UserCreateNestedManyWithoutInstanceInput = {
		create?:
			| XOR<
					UserCreateWithoutInstanceInput,
					UserUncheckedCreateWithoutInstanceInput
			  >
			| UserCreateWithoutInstanceInput[]
			| UserUncheckedCreateWithoutInstanceInput[];
		connectOrCreate?:
			| UserCreateOrConnectWithoutInstanceInput
			| UserCreateOrConnectWithoutInstanceInput[];
	...
	export type ExternalLinksCreateNestedManyWithoutInstitutionInstanceInput = {
		create?:
			| XOR<
					ExternalLinksCreateWithoutInstitutionInstanceInput,
					ExternalLinksUncheckedCreateWithoutInstitutionInstanceInput
			  >
			| ExternalLinksCreateWithoutInstitutionInstanceInput[]
			| ExternalLinksUncheckedCreateWithoutInstitutionInstanceInput[];
		connectOrCreate?:
			| ExternalLinksCreateOrConnectWithoutInstitutionInstanceInput
			| ExternalLinksCreateOrConnectWithoutInstitutionInstanceInput[];
		createMany?: ExternalLinksCreateManyInstitutionInstanceInputEnvelope;
		connect?:
			| ExternalLinksWhereUniqueInput
			| ExternalLinksWhereUniqueInput[];
	};
	...
	export type InstitutionInstanceModuleUpdateManyWithoutInstanceNestedInput =
		{
			...
			connectOrCreate?:
				...
				| InstitutionInstanceModuleCreateOrConnectWithoutInstanceInput[];
			upsert?:
				| InstitutionInstanceModuleUpsertWithWhereUniqueWithoutInstanceInput
				| InstitutionInstanceModuleUpsertWithWhereUniqueWithoutInstanceInput[];
			createMany?: InstitutionInstanceModuleCreateManyInstanceInputEnvelope;
			set?:
				| InstitutionInstanceModuleWhereUniqueInput
			...
			connect?:
				...
				| InstitutionInstanceModuleWhereUniqueInput[];
			update?:
				| InstitutionInstanceModuleUpdateWithWhereUniqueWithoutInstanceInput
				| InstitutionInstanceModuleUpdateWithWhereUniqueWithoutInstanceInput[];
			updateMany?:
				| InstitutionInstanceModuleUpdateManyWithWhereWithoutInstanceInput
				| InstitutionInstanceModuleUpdateManyWithWhereWithoutInstanceInput[];
			deleteMany?:
				| InstitutionInstanceModuleScalarWhereInput
				| InstitutionInstanceModuleScalarWhereInput[];
		};
	...
	export type UserUpdateManyWithoutInstanceNestedInput = {
		...
		connectOrCreate?:
			...
			| UserCreateOrConnectWithoutInstanceInput[];
		upsert?:
			| UserUpsertWithWhereUniqueWithoutInstanceInput
			| UserUpsertWithWhereUniqueWithoutInstanceInput[];
		createMany?: UserCreateManyInstanceInputEnvelope;
		set?: UserWhereUniqueInput | UserWhereUniqueInput[];
		disconnect?: UserWhereUniqueInput | UserWhereUniqueInput[];
		...
		connect?: UserWhereUniqueInput | UserWhereUniqueInput[];
		update?:
			| UserUpdateWithWhereUniqueWithoutInstanceInput
			| UserUpdateWithWhereUniqueWithoutInstanceInput[];
		updateMany?:
			| UserUpdateManyWithWhereWithoutInstanceInput
			| UserUpdateManyWithWhereWithoutInstanceInput[];
		deleteMany?: UserScalarWhereInput | UserScalarWhereInput[];
	};
	...
	export type ExternalLinksUpdateManyWithoutInstitutionInstanceNestedInput = {
		...
		connectOrCreate?:
			...
			| ExternalLinksCreateOrConnectWithoutInstitutionInstanceInput[];
		upsert?:
			| ExternalLinksUpsertWithWhereUniqueWithoutInstitutionInstanceInput
			| ExternalLinksUpsertWithWhereUniqueWithoutInstitutionInstanceInput[];
		createMany?: ExternalLinksCreateManyInstitutionInstanceInputEnvelope;
		...
		connect?:
			...
			| ExternalLinksWhereUniqueInput[];
		update?:
			| ExternalLinksUpdateWithWhereUniqueWithoutInstitutionInstanceInput
			| ExternalLinksUpdateWithWhereUniqueWithoutInstitutionInstanceInput[];
		updateMany?:
			| ExternalLinksUpdateManyWithWhereWithoutInstitutionInstanceInput
			| ExternalLinksUpdateManyWithWhereWithoutInstitutionInstanceInput[];
		deleteMany?:
			| ExternalLinksScalarWhereInput
			| ExternalLinksScalarWhereInput[];
	};
	...
	export type InstitutionInstanceCreateNestedOneWithoutModulesInput = {
		create?: XOR<
			InstitutionInstanceCreateWithoutModulesInput,
			InstitutionInstanceUncheckedCreateWithoutModulesInput
		>;
	...
	export type InstitutionInstanceModuleTypeCreateNestedOneWithoutInstitutionInstanceModuleInput =
		{
			create?: XOR<
				InstitutionInstanceModuleTypeCreateWithoutInstitutionInstanceModuleInput,
				InstitutionInstanceModuleTypeUncheckedCreateWithoutInstitutionInstanceModuleInput
			>;
	...
	export type InstitutionInstanceUpdateOneRequiredWithoutModulesNestedInput =
		{
			...
			update?: XOR<
				XOR<
					InstitutionInstanceUpdateToOneWithWhereWithoutModulesInput,
					InstitutionInstanceUpdateWithoutModulesInput
				>,
				InstitutionInstanceUncheckedUpdateWithoutModulesInput
			>;
		};
	...
	export type InstitutionInstanceModuleTypeUpdateOneRequiredWithoutInstitutionInstanceModuleNestedInput =
		{
			...
			update?: XOR<
				XOR<
					InstitutionInstanceModuleTypeUpdateToOneWithWhereWithoutInstitutionInstanceModuleInput,
					InstitutionInstanceModuleTypeUpdateWithoutInstitutionInstanceModuleInput
				>,
				InstitutionInstanceModuleTypeUncheckedUpdateWithoutInstitutionInstanceModuleInput
			>;
		};
	...
	export type InstitutionInstanceModuleCreateNestedManyWithoutTypeInput = {
		create?:
			| XOR<
					InstitutionInstanceModuleCreateWithoutTypeInput,
					InstitutionInstanceModuleUncheckedCreateWithoutTypeInput
			  >
			| InstitutionInstanceModuleCreateWithoutTypeInput[]
			| InstitutionInstanceModuleUncheckedCreateWithoutTypeInput[];
		connectOrCreate?:
			| InstitutionInstanceModuleCreateOrConnectWithoutTypeInput
			| InstitutionInstanceModuleCreateOrConnectWithoutTypeInput[];
	...
	export type InstitutionInstanceModuleUpdateManyWithoutTypeNestedInput = {
		...
		connectOrCreate?:
			...
			| InstitutionInstanceModuleCreateOrConnectWithoutTypeInput[];
		upsert?:
			| InstitutionInstanceModuleUpsertWithWhereUniqueWithoutTypeInput
			| InstitutionInstanceModuleUpsertWithWhereUniqueWithoutTypeInput[];
		createMany?: InstitutionInstanceModuleCreateManyTypeInputEnvelope;
		set?:
			| InstitutionInstanceModuleWhereUniqueInput
		...
		connect?:
			...
			| InstitutionInstanceModuleWhereUniqueInput[];
		update?:
			| InstitutionInstanceModuleUpdateWithWhereUniqueWithoutTypeInput
			| InstitutionInstanceModuleUpdateWithWhereUniqueWithoutTypeInput[];
		updateMany?:
			| InstitutionInstanceModuleUpdateManyWithWhereWithoutTypeInput
			| InstitutionInstanceModuleUpdateManyWithWhereWithoutTypeInput[];
		deleteMany?:
			| InstitutionInstanceModuleScalarWhereInput
			| InstitutionInstanceModuleScalarWhereInput[];
	...
	export type NestedEnumExternalLinkScopeWithAggregatesFilter<
		$PrismaModel = never,
	> = {
		equals?:
			| $Enums.ExternalLinkScope
	...
	export type InstitutionInstanceModuleCreateManyInstanceInputEnvelope = {
		data:
			| InstitutionInstanceModuleCreateManyInstanceInput
			| InstitutionInstanceModuleCreateManyInstanceInput[];
		skipDuplicates?: boolean;
	};
	...
	export type ExternalLinksCreateManyInstitutionInstanceInputEnvelope = {
		data:
			| ExternalLinksCreateManyInstitutionInstanceInput
			| ExternalLinksCreateManyInstitutionInstanceInput[];
		skipDuplicates?: boolean;
	};
	...
	export type InstitutionInstanceModuleUpsertWithWhereUniqueWithoutInstanceInput =
		{
			where: InstitutionInstanceModuleWhereUniqueInput;
			update: XOR<
				InstitutionInstanceModuleUpdateWithoutInstanceInput,
				InstitutionInstanceModuleUncheckedUpdateWithoutInstanceInput
			>;
			create: XOR<
				InstitutionInstanceModuleCreateWithoutInstanceInput,
				InstitutionInstanceModuleUncheckedCreateWithoutInstanceInput
	...
	export type InstitutionInstanceModuleUpdateManyWithWhereWithoutInstanceInput =
		{
			...
			data: XOR<
				InstitutionInstanceModuleUpdateManyMutationInput,
				InstitutionInstanceModuleUncheckedUpdateManyWithoutInstanceInput
			>;
		};
	...
	export type UserUpsertWithWhereUniqueWithoutInstanceInput = {
		where: UserWhereUniqueInput;
		update: XOR<
			UserUpdateWithoutInstanceInput,
			UserUncheckedUpdateWithoutInstanceInput
		>;
		create: XOR<
			UserCreateWithoutInstanceInput,
			UserUncheckedCreateWithoutInstanceInput
	...
	export type UserUpdateManyWithWhereWithoutInstanceInput = {
		...
		data: XOR<
			UserUpdateManyMutationInput,
			UserUncheckedUpdateManyWithoutInstanceInput
		>;
	};
	...
	export type ExternalLinksUpsertWithWhereUniqueWithoutInstitutionInstanceInput =
		{
			where: ExternalLinksWhereUniqueInput;
			update: XOR<
				ExternalLinksUpdateWithoutInstitutionInstanceInput,
				ExternalLinksUncheckedUpdateWithoutInstitutionInstanceInput
			>;
			create: XOR<
				ExternalLinksCreateWithoutInstitutionInstanceInput,
				ExternalLinksUncheckedCreateWithoutInstitutionInstanceInput
	...
	export type ExternalLinksUpdateManyWithWhereWithoutInstitutionInstanceInput =
		{
			...
			data: XOR<
				ExternalLinksUpdateManyMutationInput,
				ExternalLinksUncheckedUpdateManyWithoutInstitutionInstanceInput
			>;
		};
	...
	export type InstitutionInstanceModuleCreateManyTypeInputEnvelope = {
		data:
			| InstitutionInstanceModuleCreateManyTypeInput
			| InstitutionInstanceModuleCreateManyTypeInput[];
		skipDuplicates?: boolean;
	};
	...
	export type InstitutionInstanceModuleUpsertWithWhereUniqueWithoutTypeInput =
		{
			where: InstitutionInstanceModuleWhereUniqueInput;
			update: XOR<
				InstitutionInstanceModuleUpdateWithoutTypeInput,
				InstitutionInstanceModuleUncheckedUpdateWithoutTypeInput
			>;
			create: XOR<
				InstitutionInstanceModuleCreateWithoutTypeInput,
				InstitutionInstanceModuleUncheckedCreateWithoutTypeInput
	...
	export type InstitutionInstanceModuleUpdateManyWithWhereWithoutTypeInput = {
		...
		data: XOR<
			InstitutionInstanceModuleUpdateManyMutationInput,
			InstitutionInstanceModuleUncheckedUpdateManyWithoutTypeInput
		>;
	};
